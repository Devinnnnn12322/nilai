...
<head>
    ...
    <title>Beranda Aplikasi Nilai By Devianda Nurvaldianto</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href=".">
                <img src="logo.webpro.jpeg" alt="" height="74px">
                WEB PRO
            </a>
    ...
    <div class="fixed-bottom">
        <div class="container">
            <div class="card">
                <div class="card-body">
                    &copy; 2024-<?= date("Y") ?> - WEB Programing by Devianda Nurvaldianto
                </div>
            </div>
        </div>
    </div>
